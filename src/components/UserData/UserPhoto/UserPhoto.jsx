...
export const UserPhoto = () => {
  ...
  const { handleSubmit, setFieldValue } = useFormik({
    ...
    onSubmit: async ({ photoURL }) => {
      ...
      // No need to manually call updateAvatar here since it will be triggered automatically by the useEffect hook
    },
  });
  ...
  return (
    <>
      <AvatarWrapper onSubmit={handleSubmit}>
        ...
        />
        <EditPhotoBtn type="button" onClick={handleFileSelect}>
          <Kamera />
